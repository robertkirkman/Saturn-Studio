...
const LevelScript level_castle_inside_entry[] = {
    ...
    AREA(/*index*/ 1, castle_geo_001400),
        ...
        OBJECT(/*model*/ MODEL_TOAD,       /*pos*/ -1671,    0,  1313, /*angle*/ 0,  83, 0, /*behParam*/ (DIALOG_133 << 24) | (0 << 16), /*beh*/ bhvToadMessage),
        OBJECT(/*model*/ MODEL_TOAD,       /*pos*/  1524,  307,   458, /*angle*/ 0, 110, 0, /*behParam*/ (DIALOG_134 << 24) | (1 << 16), /*beh*/ bhvToadMessage),
        OBJECT(/*model*/ MODEL_TOAD,       /*pos*/   596, -306, -2637, /*angle*/ 0, 152, 0, /*behParam*/ (DIALOG_135 << 24) | (2 << 16), /*beh*/ bhvToadMessage),
    ...
    AREA(/*index*/ 2, castle_geo_001858),
        ...
        OBJECT(/*model*/ MODEL_TOAD,                     /*pos*/  -977, 1203, 2569, /*angle*/ 0,   0, 0, /*behParam*/ (DIALOG_076 << 24) | (3 << 16), /*beh*/ bhvToadMessage),
        OBJECT(/*model*/ MODEL_TOAD,                     /*pos*/ -1584, 2253, 7157, /*angle*/ 0, 136, 0, /*behParam*/ (DIALOG_083 << 24) | (4 << 16), /*beh*/ bhvToadMessage),
        OBJECT(/*model*/ MODEL_TOAD,                     /*pos*/   837, 1203, 3020, /*angle*/ 0, 180, 0, /*behParam*/ (DIALOG_137 << 24) | (5 << 16), /*beh*/ bhvToadMessage),
    ...
    AREA(/*index*/ 3, castle_geo_001C10),
        ...
        OBJECT(/*model*/ MODEL_TOAD,                      /*pos*/  1787, -1381, -1957, /*angle*/ 0, 126, 0, /*behParam*/ (DIALOG_082 << 24) | (6 << 16), /*beh*/ bhvToadMessage),
        OBJECT(/*model*/ MODEL_TOAD,                      /*pos*/ -4048, -1381, -1334, /*angle*/ 0,  30, 0, /*behParam*/ (DIALOG_136 << 24) | (7 << 16), /*beh*/ bhvToadMessage),
