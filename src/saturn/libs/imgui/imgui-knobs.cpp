...
namespace ImGuiKnobs {
    namespace detail {
        ...
        color_set GetPrimaryColorSet() {
            ...
            return {colors[ImGuiCol_CheckMark], colors[ImGuiCol_CheckMark], colors[ImGuiCol_CheckMark]};
        }

        color_set GetSecondaryColorSet() {
            auto *colors = ImGui::GetStyle().Colors;
            auto active = ImVec4(
                    colors[ImGuiCol_FrameBg].x,
                    colors[ImGuiCol_FrameBg].y,
                    colors[ImGuiCol_FrameBg].z,
                    colors[ImGuiCol_FrameBg].w);

            auto hovered = ImVec4(
                    colors[ImGuiCol_FrameBgHovered].x,
                    colors[ImGuiCol_FrameBgHovered].y,
                    colors[ImGuiCol_FrameBgHovered].z,
                    colors[ImGuiCol_FrameBgHovered].w);
